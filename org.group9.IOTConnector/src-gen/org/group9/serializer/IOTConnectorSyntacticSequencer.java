...
public class IOTConnectorSyntacticSequencer extends AbstractSyntacticSequencer {

	protected IOTConnectorGrammarAccess grammarAccess;
	...
	protected void init(IGrammarAccess access) {
		grammarAccess = (IOTConnectorGrammarAccess) access;
	 ...
	 *     (rule start) (ambiguity) readingName=ReadingNameWithConfigScope
