 ...
 * </p>
 * <ul>
 *   <li>{@link org.group9.iOTConnector.impl.ConfigImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.group9.iOTConnector.impl.ConfigImpl#getSensors <em>Sensors</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ConfigImpl extends MinimalEObjectImpl.Container implements Config
{
  ...
  {
    return IOTConnectorPackage.Literals.CONFIG;
  }
  ...
  public void setName(String newName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, IOTConnectorPackage.CONFIG__NAME, oldName, name));
  }
  ...
  public EList<Sensor> getSensors()
  {
    if (sensors == null)
    {
      sensors = new EObjectContainmentEList<Sensor>(Sensor.class, this, IOTConnectorPackage.CONFIG__SENSORS);
    }
    return sensors;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case IOTConnectorPackage.CONFIG__SENSORS:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case IOTConnectorPackage.CONFIG__NAME:
        return getName();
      case IOTConnectorPackage.CONFIG__SENSORS:
        return getSensors();
    }
